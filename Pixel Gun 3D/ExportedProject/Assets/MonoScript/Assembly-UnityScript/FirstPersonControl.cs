...
public class FirstPersonControl : MonoBehaviour
{
	...
	public void Start()
	{
		...
		rightjoystick = GameObject.Find("RightTouchPad").GetComponent<Joystick>();
	...
	public void popal(NetworkViewID id)
	{
	...
	public void Update()
	{
		...
		{
			leftjoystick.position = updateKeyboardControls();
			...
			{
				keychainPlugin.updateKCValue(keychainPlugin.getKCValue(Defs.Coins) + 999, Defs.Coins);
			}
						if (Input.GetKey(KeyCode.Space))
			{
				rightjoystick.jumpPressed = true;
			}
