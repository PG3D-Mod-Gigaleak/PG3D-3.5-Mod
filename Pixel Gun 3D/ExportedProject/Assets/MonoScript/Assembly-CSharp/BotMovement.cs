...
public class BotMovement : MonoBehaviour
{
	...
	private GameObject player;
        ...
        return Defs.CAnim(base.transform.GetChild(0).gameObject, a);
    }
	...
	{
		_modelChild.GetComponent<Animation>().Stop();
		if ((bool)_modelChild.GetComponent<Animation>()[myCAnim(myCAnim(normWalkAnim))])
		{
			_modelChild.GetComponent<Animation>().CrossFade(myCAnim(myCAnim(normWalkAnim)));
		}
		else
		{
			_modelChild.GetComponent<Animation>().CrossFade(myCAnim(myCAnim(zombieWalkAnim)));
		}
	}
