...
{
	[CompilerGenerated]
	private sealed class _003CReportAchievementProgress_003Ec__AnonStorey15
	{
		internal bool success;

		internal GameCenterSingleton _003C_003Ef__this;

		internal void _003C_003Em__6(bool result)
		{
			if (result)
			{
				success = true;
	...
	public void ReportScore(long score)
	{
		...
		{
			_003C_003Ef__am_0024cache4 = _003CReportScore_003Em__4;
		}
	...
	{
		Social.LoadScores(_leaderboardID, _003CGetScore_003Em__5);
	}
	...
	public bool ReportAchievementProgress(string achievementID, float progressCompleted)
	{
		if (Social.localUser.authenticated)
		{
			...
			{
				_003CReportAchievementProgress_003Ec__AnonStorey15 _003CReportAchievementProgress_003Ec__AnonStorey = new _003CReportAchievementProgress_003Ec__AnonStorey15();
				...
				Social.ReportProgress(achievementID, progressCompleted, _003CReportAchievementProgress_003Ec__AnonStorey._003C_003Em__6);
	...
	[CompilerGenerated]
	private static void _003CReportScore_003Em__4(bool success)
	{
		Debug.Log((!success) ? "Failed to report score" : "Reported score successfully");
	}

	[CompilerGenerated]
	private void _003CGetScore_003Em__5(IScore[] scores)
	{
		if (scores.Length > 0)
		{
